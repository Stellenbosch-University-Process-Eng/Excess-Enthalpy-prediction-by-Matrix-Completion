...
num_non_zero_feat_var = 1+2*(chain_id+1) # number of non-zero feature variances values

# data file
data_file = f'data.json'
path = f'Results/Include_clusters_{include_clusters}/Add_zeros_{add_zeros}/RefT_{refT}'

os.makedirs(path, exist_ok=True)

# Adjust data to reflect number of non-zero feature variances variances
